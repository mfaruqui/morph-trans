...
class EncDec {
 public:
  ...
  EncDec(const unsigned& char_length, const unsigned& hidden_length,
...
void Serialize(string& filename, EncDec& model, vector<Model*>* cnn_model);

void Read(string& filename, EncDec* model, vector<Model*>* cnn_model);
